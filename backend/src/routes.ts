...
import { businessOperationsRouter } from "./modules/business-operations/business-operations.routes";
import { engineeringOperationsRouter } from "./modules/engineering-operations/engineering-operations.routes";
import { platformIntelligenceRouter } from "./modules/platform-intelligence/platform-intelligence.routes";
...
apiRouter.use("/admin/intelligence", platformIntelligenceRouter);
...
apiRouter.use("/admin/business", businessOperationsRouter);
apiRouter.use("/admin/executive", businessOperationsRouter);
apiRouter.use("/admin/engineering", engineeringOperationsRouter);
