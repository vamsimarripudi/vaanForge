...
export const SHELL_DEFINITIONS: ShellDefinition[] = [
  ...
  shell("profile", "Profile", "account", "authenticated", "profile", "Personal account, sessions, usage, API keys, notifications, and activity.", ["Overview:profile", "Security:admin-security", "Usage:billing-usage", "Plan:pricing", "API Keys:developer-api-keys"], "noindex,nofollow"),
  shell("settings", "Settings", "account", "workspace_member", "settings", "Workspace and account configuration shell.", ["Workspace:settings", "Team:settings", "Billing:billing", "Security:admin-security", "Privacy:privacy", "Support:support"], "noindex,nofollow"),
  ...
  shell("support", "Support", "support", "support_access", "support", "Support tickets, knowledge base, announcements, status, and contact.", ["Dashboard:support", "Tickets:support", "Knowledge Base:help", "Status:status", "Contact:support"], "noindex,nofollow"),
  ...
  shell("developers", "Developers", "developer", "developer_access", "developers", "Developer portal, apps, API keys, SDKs, webhooks, docs, and usage.", ["Overview:developers", "Apps:developer-apps", "API Keys:developer-api-keys", "Webhooks:developer-webhooks", "Docs:developer-docs", "Usage:developer-usage"], "noindex,nofollow"),
  shell("marketplace", "Marketplace", "developer", "public", "marketplace", "Reviewed apps, templates, plugins, and publisher workflows.", ["Browse:marketplace", "Installed:marketplace-installed", "Publisher:developers", "Categories:marketplace"], "index,follow"),
  ...
  shell("admin", "Admin", "admin", "admin_access", "admin", "Administrative control plane.", ["Dashboard:admin", "Billing:admin-billing", "Support:support", "Agents:admin-agents", "Audit:admin-audit", "Security:admin-security", "Operations:admin-operations"], "noindex,nofollow"),
